/*Enunciado: Crea una función que evalúe si un/a atleta ha superado correctamente una carrera de obstáculos.
 - La función recibirá dos parámetros: - Un array que sólo puede contener String con las palabras 'run' o 'jump'.
  ...
  - Si hace 'jump' en '_' (suelo), se variará la pista por 'x'. - Si hace 'run' en '|' (valla), se variará la pista por '/'. 
